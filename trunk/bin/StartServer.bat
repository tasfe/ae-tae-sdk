...
set JAVA_OPTS=%JAVA_OPTS% -javaagent:%DCSDK_HOME%/lib/taobao/ae-sdk-agent-2.0.0-SNAPSHOT.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Xrunjdwp:transport=dt_socket,address=2020,server=y,suspend=n
